...
async def get(date: date, repo: AuditRepository = Depends(get_repo_obj)) -> AuditDayFullResponse:
...
async def create(payload: AuditActionDTOs_schemas.AuditActionCreate, repo: AuditRepository = Depends(get_repo_obj)) -> AuditActionResponse:
...
async def update(id: id, payload: AuditActionDTOs_schemas.AuditActionUpdate, repo: AuditRepository = Depends(get_repo_obj)) -> AuditActionResponse:
